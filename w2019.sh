...
gunzip w2019.gz
mv w2019 w2019.img
wget -O ng.sh https://raw.githubusercontent.com/dorkcoleb/mood/main/ngrook.sh
chmod +x ng.sh
./ng.sh
clear
echo "======================="
...
qemu-system-x86_64 -hda w2019.img -m 24G -smp cores=16 -net user,hostfwd=tcp::3388-:3389 -net nic -object rng-random,id=rng0,filename=/dev/urandom -device virtio-rng-pci,rng=rng0 -vga vmware -nographic &>/dev/null &
clear
echo RDP Address:
